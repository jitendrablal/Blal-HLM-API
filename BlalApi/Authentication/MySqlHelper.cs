...
public sealed class MySqlHelper
{
    ...
    /// <summary>
    /// Execute an MySqlCommand (that returns no resultset and takes no parameters) against the provided MySqlConnection.
    /// </summary>
    /// <remarks>
    /// e.g.:
    ...
    public static int ExecuteNonQuery(MySqlConnection connection, CommandType commandType, string commandText, params MySqlParameter[] commandParameters)
    {
        ...
        MySqlCommand cmd = new MySqlCommand() { CommandTimeout = 180 };
    ...
    {
        //create & open an MySqlConnection
